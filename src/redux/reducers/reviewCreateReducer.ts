...
export const reviewCreateReducer = createReducer<ReviewCreateState, ReviewCreateActionType>(initialState)
    .handleAction(
        [reviewCreateAsyncAction.request, reviewCreateAsyncAction.success, reviewCreateAsyncAction.failure],
