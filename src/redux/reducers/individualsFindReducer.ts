...
import {
  individualsFindActionType,
  IndividualsFindState,
} from '../action_types/individualsFindActionType'
...
export const individualsFindReducer = createReducer<
  IndividualsFindState,
  individualsFindActionType
>(initialState).handleAction(
  [
    individualsFindAsyncAction.request,
    individualsFindAsyncAction.success,
    individualsFindAsyncAction.failure,
  ],
