...
import MyPage from './presentation/MyPage'
...
const Buttons = () => (
  <>
    ...
    <OutlinedButton title="삭제하기" disabled radius={theme.radius?.sm} />
    <OutlinedButton title="종료하기" radius={theme.radius?.sm} />
    <OutlinedButton title="해산하기" disabled radius={theme.radius?.sm} />
    <Text h3>Outlined Buttons</Text>
    <View style={styles.wrapButtonConatiner}>
      <OutlinedButton title="중복확인" radius={theme.radius?.lg} highlighted />
      <OutlinedButton title="확인완료" radius={theme.radius?.lg} highlighted disabled />
    </View>
    <AirbnbRating
      count={5}
...
const Cards = () => (
  <>
    ...
    <DivideWrapper>
      <MenuCard title="지원소식" iconName="apps" />
      <MenuCard title="내가 쓴 글 보기" iconName="albums" />
      <MenuCard title="팀 히스토리" iconName="people" />
    </DivideWrapper>
          ...
          <NavigationContainer>
            <RootStack.Navigator initialRouteName="Main">
              <RootStack.Group screenOptions={{headerShown: false}}>
                <RootStack.Screen name="Buttons" component={Buttons} />
                <RootStack.Screen name="Inputs" component={Inputs} />
