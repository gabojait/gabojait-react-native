...
T extends keyof OnboardingStackParamList = 'Login'
> = StackNavigationProp<OnboardingStackParamList, T>

export type OnboardingStackNavigationProps<
  T extends keyof OnboardingStackParamList = 'Login'
> = CompositeNavigationProp< OnboardingNavigationProp<T>, RootStackNavigationProps<'OnboardingNavigation'>>
...
const OnboardingNavigation= () => {
    return (
        <OnboardingStack.Navigator initialRouteName='Login'>
            ...
            <OnboardingStack.Screen name="FindAccount" component={FindAccount}
            options={{
                header: BackHeader
            }}/>
            <OnboardingStack.Screen name="CompleteOnboarding" component={CompleteOnboarding}
            options={{
                headerShown:false
            }}/>
