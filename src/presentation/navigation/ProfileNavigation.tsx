...
import EditMain from '../screens/Main/MyPage/Profile/EditMain'
  ...
  return (
    <Profile.Navigator initialRouteName='View'>
      <Profile.Group>
        ...
        <Profile.Screen name="EditMain" options={{header: TitleWithCloseHeader, headerTitle: "프로필"}} component={EditMain} />
        <Profile.Screen name="EditPortfolio" options={{header: TitleWithCloseHeader, headerTitle: "포트폴리오"}} component={EditPortfolio} />
