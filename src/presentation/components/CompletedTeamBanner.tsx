...
const CompletedTeamBanner: React.FC<CardProps & {team: TeamBriefDto}> = ({
    team
  }) => {
    const {theme} = useTheme()
    const positions = [[team.backends.length, 'B'], [team.frontends.length, 'F'], [team.designers.length, 'D'], [team.projectManagers.length, 'P']]
